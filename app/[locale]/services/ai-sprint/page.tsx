...
import { BarChart3, Bot, Lightbulb, ShieldCheck, Sparkles, Target, Zap } from 'lucide-react';
...
export default async function AISprintPage({ params }: { params: Promise<{ locale: Locale }> }) {
  ...
  return (
    <main className='relative container mx-auto min-h-[calc(100vh-4rem)] overflow-hidden px-4 sm:px-6 lg:px-8'>
      <div className='relative z-10 mx-auto max-w-6xl py-8 sm:py-12 lg:py-16'>
          ...
          <Card className='relative border-0 bg-transparent'>
            <CardContent className='p-0'>
              <div className='flex flex-col items-center text-center md:items-start md:text-left'>
                ...
                <p className='text-primary mb-2 text-xl font-semibold sm:text-2xl md:text-3xl'>
                  {t('hero.subtitle')}
                </p>
        ...
        <div className='mb-10 sm:mb-12 lg:mb-16'>
          <Card className='bg-primary/5 border-primary/20 rounded-3xl border-2 p-6 sm:p-8'>
            <CardContent className='p-0'>
              ...
              <p className='text-foreground/70 text-base sm:text-lg'>{t('whatYouGet.summary')}</p>
            </CardContent>
          </Card>
        </div>
        ...
        {/* FAQ */}
        <div className='mb-10 sm:mb-12 lg:mb-16'>
          <h2 className='mb-6 text-2xl font-bold sm:text-3xl lg:text-4xl'>{t('faq.title')}</h2>
        ...
        {/* Glossary */}
        <div className='mb-10 sm:mb-12 lg:mb-16'>
          <h2 className='mb-6 text-2xl font-bold sm:text-3xl lg:text-4xl'>{t('glossary.title')}</h2>
          <div className='grid gap-4 sm:gap-6 md:grid-cols-2'>
            {[0, 1, 2].map((idx) => (
              <Card
                key={idx}
